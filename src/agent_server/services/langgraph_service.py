...
def create_run_config(
    ...
    # Set recursion limit to prevent infinite tool-call loops.
    # Each tool-call cycle (execute_with_skill + handle_tool_calls) uses 2 steps,
    # plus plan_skill + load_skill + first execute uses 3. A limit of 25 allows
    # roughly 10 tool-call rounds per invocation.
